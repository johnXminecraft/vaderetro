...
import net.minecraft.src.vaderetro.johnchurchmod.gen.world.WorldGenChurches;
...
public class ChunkProviderGenerate implements IChunkProvider {
	...
	public void populate(IChunkProvider var1, int var2, int var3) {
		...
		for(var13 = 0; var13 < 20; ++var13) {
			...
			var15 = this.rand.nextInt(64);
			var16 = var5 + this.rand.nextInt(16);
			(new WorldGenMinable(Block.oreCopper.blockID, 8)).generate(this.worldObj, this.rand, var14, var15, var16);
		}
		...
		for(var13 = 0; var13 < 20; ++var13) {
			...
			var15 = this.rand.nextInt(64);
			var16 = var5 + this.rand.nextInt(16);
			(new WorldGenMinable(Block.oreTin.blockID, 8)).generate(this.worldObj, this.rand, var14, var15, var16);
		}
