...
public class EntityMusketBullet extends Entity {
    ...
    public EntityMusketBullet(World var1) {
        super(var1);
        this.setSize(0.5F, 0.5F);
    }

    public EntityMusketBullet(World var1, double var2, double var4, double var6) {
        super(var1);
        this.setSize(0.5F, 0.5F);
    ...
    public EntityMusketBullet(World var1, EntityLiving var2) {
        super(var1);
        this.owner = var2;
        ...
        this.setBulletHeading(this.motionX, this.motionY, this.motionZ, 1.5F, 1.0F);
    }
    ...
    public void onCollideWithPlayer(EntityPlayer var1) {
        if(!this.worldObj.multiplayerWorld) {
            if(this.inGround && this.doesBulletBelongToPlayer && this.bulletShake <= 0 && var1.inventory.addItemStackToInventory(new ItemStack(Item.musketBullet, 1))) {
