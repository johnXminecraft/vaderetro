package net.minecraft.src.vaderetro.johnindustrialmod.entity.tileentity;

import net.minecraft.src.*;
import net.minecraft.src.vaderetro.johnindustrialmod.block.BlockOpenHearthFurnace;
import net.minecraft.src.vaderetro.johnindustrialmod.recipes.OpenHearthFurnaceRecipes;
