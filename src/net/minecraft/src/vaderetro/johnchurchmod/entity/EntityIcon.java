package net.minecraft.src.vaderetro.johnchurchmod.entity;

import net.minecraft.src.*;
import net.minecraft.src.vaderetro.johnchurchmod.enumeration.EnumIcon;

import java.util.ArrayList;
import java.util.List;

public class EntityIcon extends Entity {
    ...
    public EntityIcon(World var1, int var2, int var3, int var4, int var5) {
        this(var1);
        this.xPosition = var2;
        this.yPosition = var3;
        this.zPosition = var4;
        ArrayList var6 = new ArrayList();
        EnumIcon[] var7 = EnumIcon.values();
        int var8 = var7.length;

        for(int var9 = 0; var9 < var8; ++var9) {
            EnumIcon var10 = var7[var9];
            this.icon = var10;
        ...
        if(var6.size() > 0) {
            this.icon = (EnumIcon)var6.get(this.rand.nextInt(var6.size()));
        }

        this.func_412_b(var5);
    }

    public EntityIcon(World var1, int var2, int var3, int var4, int var5, String var6) {
        this(var1);
        this.xPosition = var2;
        this.yPosition = var3;
        this.zPosition = var4;
    ...
    public void func_412_b(int var1) {
        ...
        float var2 = (float)this.icon.sizeX;
        float var3 = (float)this.icon.sizeY;
        float var4 = (float)this.icon.sizeX;
        if(var1 != 0 && var1 != 2) {
            var2 = 0.5F;
        } else {
            var4 = 0.5F;
        ...
        if(var1 == 0) {
            var5 -= this.func_411_c(this.icon.sizeX);
        }

        if(var1 == 1) {
            var7 += this.func_411_c(this.icon.sizeX);
        }
        ...
        var6 += this.func_411_c(this.icon.sizeY);
    ...
    public void onUpdate() {
        if(this.field_695_c++ == 100 && !this.worldObj.multiplayerWorld) {
            ...
            if(!this.func_410_i()) {
                this.setEntityDead();
                this.worldObj.entityJoinedWorld(new EntityItem(this.worldObj, this.posX, this.posY, this.posZ, new ItemStack(Item.icon)));
            }
        }
    ...
    public boolean func_410_i() {
        if(this.worldObj.getCollidingBoundingBoxes(this, this.boundingBox).size() > 0) {
            ...
            int var1 = this.icon.sizeX / 16;
            int var2 = this.icon.sizeY / 16;
            int var3 = this.xPosition;
            int var4 = this.yPosition;
            int var5 = this.zPosition;
            if(this.direction == 0) {
                var3 = MathHelper.floor_double(this.posX - (double)((float)this.icon.sizeX / 32.0F));
            }

            if(this.direction == 1) {
                var5 = MathHelper.floor_double(this.posZ - (double)((float)this.icon.sizeX / 32.0F));
            }
            ...
            var4 = MathHelper.floor_double(this.posY - (double)((float)this.icon.sizeY / 32.0F));
            ...
            for(var7 = 0; var7 < var9.size(); ++var7) {
                if(var9.get(var7) instanceof EntityIcon) {
                    return false;
                }
            }
    ...
    public void writeEntityToNBT(NBTTagCompound var1) {
        ...
        var1.setString("Motive", this.icon.title);
    ...
    public void readEntityFromNBT(NBTTagCompound var1) {
        ...
        EnumIcon[] var3 = EnumIcon.values();
        int var4 = var3.length;

        for(int var5 = 0; var5 < var4; ++var5) {
            EnumIcon var6 = var3[var5];
