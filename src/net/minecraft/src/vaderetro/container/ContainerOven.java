...
import net.minecraft.src.vaderetro.slot.SlotOven;
...
public class ContainerOven extends Container {
    ...
    public ContainerOven(InventoryPlayer inventoryPlayer, TileEntityOven tileEntity) {
        this.tileEntity = tileEntity;
        this.addSlot(new Slot(tileEntity, 0, 56, 17));
        this.addSlot(new Slot(tileEntity, 1, 56, 53));
        this.addSlot(new SlotOven(inventoryPlayer.player, this.tileEntity, 2, 116, 35));
