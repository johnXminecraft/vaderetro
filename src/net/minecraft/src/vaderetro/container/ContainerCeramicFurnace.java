...
import net.minecraft.src.vaderetro.slot.SlotCeramicFurnace;

public class ContainerCeramicFurnace extends Container {

    private TileEntityCeramicFurnace tileEntity;
    private int cookTime = 0;
    private int burnTime = 0;
    private int itemBurnTime = 0;

    public ContainerCeramicFurnace(InventoryPlayer inventoryPlayer, TileEntityCeramicFurnace tileEntity) {
        this.tileEntity = tileEntity;
        this.addSlot(new Slot(tileEntity, 0, 56, 17));
        this.addSlot(new Slot(tileEntity, 1, 56, 53));
        this.addSlot(new SlotCeramicFurnace(inventoryPlayer.player, this.tileEntity, 2, 116, 35));
    ...
    public void updateCraftingResults() {
        ...
        for (Object o : this.field_20121_g) {
            ...
            if (this.cookTime != this.tileEntity.cookTime) {
                var2.func_20158_a(this, 0, this.tileEntity.cookTime);
            }
            if (this.burnTime != this.tileEntity.burnTime) {
                var2.func_20158_a(this, 1, this.tileEntity.burnTime);
            }
        ...
        this.burnTime = this.tileEntity.cookTime;
        this.itemBurnTime = this.tileEntity.currentItemBurnTime;
    }

    @Override
    public void func_20112_a(int var1, int var2) {
        if(var1 == 0) this.tileEntity.cookTime = var2;
        if(var1 == 1) this.tileEntity.burnTime = var2;
