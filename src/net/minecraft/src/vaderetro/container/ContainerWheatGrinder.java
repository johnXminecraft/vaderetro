...
public class ContainerWheatGrinder extends Container {
    ...
    private TileEntityWheatGrinder m_localTileEntity;
    
    public ContainerWheatGrinder(InventoryPlayer inventoryplayer, TileEntityWheatGrinder tileEntityWheatGrinder) {
