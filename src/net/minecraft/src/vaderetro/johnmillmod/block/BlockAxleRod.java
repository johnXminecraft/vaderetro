...
public class BlockAxleRod extends BlockContainer {
	...
	protected TileEntity getBlockEntity() {
		return new net.minecraft.src.vaderetro.johnmillmod.entity.tileentity.TileEntityAxleRod();
	}
	...
	public void onBlockAdded(World world, int x, int y, int z) {
		...
		if (!(te instanceof net.minecraft.src.vaderetro.johnmillmod.entity.tileentity.TileEntityAxleRod)) {
			world.setBlockTileEntity(x, y, z, new net.minecraft.src.vaderetro.johnmillmod.entity.tileentity.TileEntityAxleRod());
		}
