...
public class TileEntityAxleRodRenderer extends TileEntitySpecialRenderer {
	public void renderTileEntityAxleRodAt(net.minecraft.src.vaderetro.johnmillmod.entity.tileentity.TileEntityAxleRod te, double x, double y, double z, float partial) {
	...
	public void renderTileEntityAt(TileEntity te, double x, double y, double z, float partial) {
		this.renderTileEntityAxleRodAt((net.minecraft.src.vaderetro.johnmillmod.entity.tileentity.TileEntityAxleRod)te, x, y, z, partial);
	}
}
