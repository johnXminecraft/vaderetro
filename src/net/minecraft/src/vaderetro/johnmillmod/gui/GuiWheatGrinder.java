package net.minecraft.src.vaderetro.johnmillmod.gui;
...
public class GuiWheatGrinder extends GuiContainer {
    ...
    private net.minecraft.src.vaderetro.johnmillmod.entity.tileentity.TileEntityWheatGrinder associatedTileEntityWheatGrinder;

	public GuiWheatGrinder(InventoryPlayer inventoryplayer, net.minecraft.src.vaderetro.johnmillmod.entity.tileentity.TileEntityWheatGrinder tileEntityWheatGrinder) {
        super(new net.minecraft.src.vaderetro.johnmillmod.container.ContainerWheatGrinder(inventoryplayer, tileEntityWheatGrinder));
