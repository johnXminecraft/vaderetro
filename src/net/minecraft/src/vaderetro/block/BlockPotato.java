...
public class BlockPotato extends BlockFlower {

    public BlockPotato(int id, int blockId) {
        super(id, blockId);
        ...
        if(world.getBlockLightValue(x, y + 1, z) >= 9) {
            ...
            if(block < 7) {
                ...
                if(random.nextInt((int)(100.0F / growthRate)) == 0) {
                    ++block;
                    world.setBlockMetadataWithNotify(x, y, z, block);
                }
            }
        }
        ...
        if(!world.multiplayerWorld) {
            for(int var7 = 0; var7 < 7; ++var7) {
                if(world.rand.nextInt(15) <= var5) {
                    ...
                    EntityItem var12 = new EntityItem(world, (double)((float)x + var9), (double)((float)y + var10), (double)((float)z + var11), new ItemStack(Item.potato));
    ...
    public int idDropped(int var1, Random var2) {
        return var1 == 7 ? Item.potato.shiftedIndex : -1;
    }
