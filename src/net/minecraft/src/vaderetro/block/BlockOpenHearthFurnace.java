...
public class BlockOpenHearthFurnace extends BlockContainer {
    ...
    private final Random oHFurnaceRand = new Random();
    ...
    public void onBlockRemoval(World var1, int var2, int var3, int var4) {
        if(!keepFurnaceInventory) {
            ...
            for(int var6 = 0; var6 < var5.getSizeInventory(); ++var6) {
                ...
                if(var7 != null) {
                    float var8 = this.oHFurnaceRand.nextFloat() * 0.8F + 0.1F;
                    float var9 = this.oHFurnaceRand.nextFloat() * 0.8F + 0.1F;
                    float var10 = this.oHFurnaceRand.nextFloat() * 0.8F + 0.1F;

                    while(var7.stackSize > 0) {
                        int var11 = this.oHFurnaceRand.nextInt(21) + 10;
                        ...
                        float var13 = 0.05F;
                        var12.motionX = (double)((float)this.oHFurnaceRand.nextGaussian() * var13);
                        var12.motionY = (double)((float)this.oHFurnaceRand.nextGaussian() * var13 + 0.2F);
                        var12.motionZ = (double)((float)this.oHFurnaceRand.nextGaussian() * var13);
