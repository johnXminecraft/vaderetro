...
public class BlockTurntable extends BlockContainer {

    public BlockTurntable(int id, int textureIndex) {
    ...
    public boolean blockActivated(World world, int x, int y, int z, EntityPlayer player) {
        if (!world.multiplayerWorld) {
            TileEntityTurntable tileEntity = (TileEntityTurntable) world.getBlockTileEntity(x, y, z);
            player.displayGUITurntable(tileEntity);
        }
        return true;
    }
