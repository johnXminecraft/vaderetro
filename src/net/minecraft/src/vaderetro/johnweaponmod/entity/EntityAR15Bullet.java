package net.minecraft.src.vaderetro.johnweaponmod.entity;

import net.minecraft.src.*;

import java.util.List;

public class EntityAR15Bullet extends Entity {
    ...
    public boolean doesBulletBelongToPlayer = false;
    public int bulletShake = 0;
    public EntityLiving owner;
    private int ticksInGround;
    private int ticksInAir = 0;

    public EntityAR15Bullet(World var1) {
        super(var1);
        this.setSize(0.3F, 0.3F); 
    }

    public EntityAR15Bullet(World var1, double var2, double var4, double var6) {
        super(var1);
        this.setSize(0.3F, 0.3F);
    ...
    public EntityAR15Bullet(World var1, EntityLiving var2) {
        super(var1);
        this.owner = var2;
        this.doesBulletBelongToPlayer = var2 instanceof EntityPlayer;
        this.setSize(0.3F, 0.3F);
        ...
        this.setBulletHeading(this.motionX, this.motionY, this.motionZ, 3.0F, 0.3F); // AR15 shoots faster and more accurately
    }
    ...
    public void setBulletHeading(double var1, double var3, double var5, float var7, float var8) {
        ...
        var3 /= (double)var9;
        var5 /= (double)var9;
        var1 += this.rand.nextGaussian() * (double)0.005F * (double)var8;
        var3 += this.rand.nextGaussian() * (double)0.005F * (double)var8;
        var5 += this.rand.nextGaussian() * (double)0.005F * (double)var8;
        var1 *= (double)var7;
        var3 *= (double)var7;
        var5 *= (double)var7;
        this.motionX = var1;
    ...
    public void writeEntityToNBT(NBTTagCompound var1) {
        ...
        var1.setByte("shake", (byte)this.bulletShake);
        var1.setByte("inGround", (byte)(this.inGround ? 1 : 0));
        var1.setBoolean("player", this.doesBulletBelongToPlayer);
    }
    ...
    public void readEntityFromNBT(NBTTagCompound var1) {
        ...
        this.bulletShake = var1.getByte("shake") & 255;
        this.inGround = var1.getByte("inGround") == 1;
        this.doesBulletBelongToPlayer = var1.getBoolean("player");
    }
