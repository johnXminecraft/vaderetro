...
public class RenderMusketBullet extends Render {
    ...
    public void renderBullet(EntityMusketBullet var1, double var2, double var4, double var6, float var8, float var9) {
        if(var1.prevRotationYaw != 0.0F || var1.prevRotationPitch != 0.0F) {
            this.loadTexture("/item/bullets.png");
            GL11.glPushMatrix();
    ...
    public void doRender(Entity var1, double var2, double var4, double var6, float var8, float var9) {
        this.renderBullet((EntityMusketBullet) var1, var2, var4, var6, var8, var9);
    }
}
