package net.minecraft.src.vaderetro.johnweaponmod.render;
...
public class RenderAR15Bullet extends Render {

    public void renderBullet(EntityAR15Bullet var1, double var2, double var4, double var6, float var8, float var9) {
        if(var1.prevRotationYaw != 0.0F || var1.prevRotationPitch != 0.0F) {
            this.loadTexture("/item/ar15bullets.png");
            GL11.glPushMatrix();
            ...
            float var21 = (float)var1.bulletShake - var9;
            if(var21 > 0.0F) {
    ...
    public void doRender(Entity var1, double var2, double var4, double var6, float var8, float var9) {
        this.renderBullet((EntityAR15Bullet) var1, var2, var4, var6, var8, var9);
    }
}
