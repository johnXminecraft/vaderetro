package net.minecraft.src.vaderetro.johnfarmmod.block;

import net.minecraft.src.*;
import java.util.Random;

public class BlockOnion extends BlockFlower {

    public BlockOnion(int id, int blockId) {
        super(id, blockId);
        ...
        if(world.getBlockLightValue(x, y + 1, z) >= 9) {
            ...
            if(blockOnion < 3) {
                ...
                if(random.nextInt((int)(100.0F / growthRate)) == 0) {
                    ++blockOnion;
                    world.setBlockMetadataWithNotify(x, y, z, blockOnion);
                }
            }
        }
        ...
        if(!world.multiplayerWorld) {
            for(int var7 = 0; var7 < 3; ++var7) {
                if(world.rand.nextInt(15) <= var5) {
                    ...
                    EntityItem var12 = new EntityItem(world, (double)((float)x + var9), (double)((float)y + var10), (double)((float)z + var11), new ItemStack(Item.onion));
