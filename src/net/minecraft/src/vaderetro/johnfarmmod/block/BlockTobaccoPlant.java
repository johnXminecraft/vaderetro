...
public class BlockTobaccoPlant extends BlockFlower {

    public BlockTobaccoPlant(int id, int blockId) {
        super(id, blockId);
        ...
        if(!world.multiplayerWorld) {
            for(int var7 = 0; var7 < 3; ++var7) {
                if(world.rand.nextInt(15) <= var5) {
                    ...
                    EntityItem var12 = new EntityItem(world, (double)((float)x + var9), (double)((float)y + var10), (double)((float)z + var11), new ItemStack(Item.tobaccoSeeds));
