package net.minecraft.src.vaderetro.johnfarmmod.entity.wild;
...
public class EntityBoar extends EntityWild {
    ...
    public EntityBoar(World world) {
        super(world);
        if(world.getWorldChunkManager().getBiomeGenAt((int)this.posX, (int)this.posZ) == BiomeGenBase.taiga) {
            this.texture = "/mob/boar_snowy.png";
        } else {
