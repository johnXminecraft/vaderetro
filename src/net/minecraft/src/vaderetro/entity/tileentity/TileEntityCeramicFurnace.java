...
import net.minecraft.src.vaderetro.block.BlockCeramicFurnace;
import net.minecraft.src.vaderetro.recipes.processors.CeramicFurnaceRecipes;

public class TileEntityCeramicFurnace extends TileEntity implements IInventory {
    ...
    public int getCookProgressScaled(int progress) {
        return this.cookTime * progress / 200;
    }
    ...
    public void updateEntity() {
        ...
        if(!this.worldObj.multiplayerWorld) {
            ...
            if(isBurning != this.burnTime > 0) {
                isCookable = true;
                BlockCeramicFurnace.updateBlockState(this.burnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            }
        }
        if(isCookable) {
    ...
    private boolean canSmelt() {
        if(this.itemStacks[0] == null) {
            ...
            ItemStack itemStack = CeramicFurnaceRecipes.processing().getResult(this.itemStacks[0].getItem().shiftedIndex);
