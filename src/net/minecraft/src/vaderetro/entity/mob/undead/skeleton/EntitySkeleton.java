package net.minecraft.src.vaderetro.entity.mob.undead.skeleton;
		...
		if(var2 < 10.0F) {
			...
			if(this.attackTime == 0) {
				if(isUsingMusket) {
					...
					this.worldObj.playSoundAtEntity(this, "random.explode", 1.0F, 1.0F / (this.rand.nextFloat() * 0.4F + 0.8F));
