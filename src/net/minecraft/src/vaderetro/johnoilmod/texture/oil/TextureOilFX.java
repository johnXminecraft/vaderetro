package net.minecraft.src.vaderetro.johnoilmod.texture.oil;
...
public class TextureOilFX extends TextureFX {
    ...
    public TextureOilFX() {
        super(Block.oilMoving.blockIndexInTexture);
    ...
    private void createFrame1() {
        for (int y = 0; y < TEXTURE_HEIGHT; y++) {
            for (int x = 0; x < TEXTURE_WIDTH; x++) {
                ...
                int srcPos = (y * TEXTURE_WIDTH + srcX) * 4;
        ...
        adjustBrightness(frameData[1], 0.95f);
    }

    private void createFrame2() {
        for (int y = 0; y < TEXTURE_HEIGHT; y++) {
            for (int x = 0; x < TEXTURE_WIDTH; x++) {
                int srcY = (y + 1) % TEXTURE_HEIGHT;
        ...
        adjustBrightness(frameData[2], 1.05f);
    }
    ...
    private void createFrame3() {
        ...
        adjustBrightness(frameData[3], 0.98f);
    }
