package net.minecraft.src.vaderetro.johnoilmod.container;

import net.minecraft.src.*;
import net.minecraft.src.vaderetro.johnoilmod.slot.SlotKeroseneLamp;
...
public class ContainerKeroseneLamp extends Container {
    ...
    public ContainerKeroseneLamp(InventoryPlayer inventoryPlayer, TileEntityKeroseneLamp tileEntity) {
        this.tileEntity = tileEntity;
        this.addSlot(new Slot(tileEntity, 0, 56, 17));
        this.addSlot(new Slot(tileEntity, 1, 56, 53));
        this.addSlot(new SlotKeroseneLamp(inventoryPlayer.player, this.tileEntity, 2, 116, 35));
    ...
    public void updateCraftingResults() {
        ...
        for (Object o : this.field_20121_g) {
            ...
            if (this.cookTime != this.tileEntity.keroseneLampCookTime) {
                var2.func_20158_a(this, 0, this.tileEntity.keroseneLampCookTime);
            }
            if (this.burnTime != this.tileEntity.keroseneLampBurnTime) {
                var2.func_20158_a(this, 1, this.tileEntity.keroseneLampBurnTime);
            }
            if (this.itemBurnTime != this.tileEntity.currentItemBurnTime) {
                var2.func_20158_a(this, 2, this.tileEntity.currentItemBurnTime);
            }
        }
        this.cookTime = this.tileEntity.keroseneLampCookTime;
        this.burnTime = this.tileEntity.keroseneLampBurnTime;
        this.itemBurnTime = this.tileEntity.currentItemBurnTime;
    }

    @Override
    public void func_20112_a(int var1, int var2) {
        if(var1 == 0) this.tileEntity.keroseneLampCookTime = var2;
        if(var1 == 1) this.tileEntity.keroseneLampBurnTime = var2;
