...
public class IsometricScreenshotRenderer {
	...
	public void doRender() {
		...
		this.progressUpdate.func_594_b("Grabbing large screenshot");
		File outputFile = this.getOutputFile();
		this.progressUpdate.displayLoadingString("Rendering");
		...
		try {
			...
			for(int i8 = 0; i8 < i1; i8 += dWidth) {
				for(int i9 = 0; i9 < i3; i9 += dHeight) {
					this.progressUpdate.setLoadingProgress(++progress * 100 / total);
					float f1 = 0.0F;
					int i12 = i9 - i3 / 2;
					int i10 = i8 - i1 / 2;
					...
					Frustrum frustrum = new net.minecraft.src.JPM.FrustrumIsom();
